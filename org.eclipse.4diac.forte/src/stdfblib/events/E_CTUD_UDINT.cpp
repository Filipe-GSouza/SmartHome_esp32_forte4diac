 ...
 ***     1.1: 2019-07-09/Alois Zoitl - JKU - fixed bug in down counting
 *************************************************************************/

#include "E_CTUD_UDINT.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "E_CTUD_UDINT_gen.cpp"
#endif
...
FORTE_E_CTUD_UDINT::FORTE_E_CTUD_UDINT(const CStringDictionary::TStringId paInstanceNameId, CResource *const paSrcRes) :
...
void FORTE_E_CTUD_UDINT::enterStateSTART(CEventChainExecutionThread *const paECET) {
...
CIEC_ANY *FORTE_E_CTUD_UDINT::getDIO(size_t) {
  return nullptr;
}
...
CInOutDataConnection **FORTE_E_CTUD_UDINT::getDIOInConUnchecked(TPortId) {
  return nullptr;
}

CInOutDataConnection *FORTE_E_CTUD_UDINT::getDIOOutConUnchecked(TPortId) {
  return nullptr;
}

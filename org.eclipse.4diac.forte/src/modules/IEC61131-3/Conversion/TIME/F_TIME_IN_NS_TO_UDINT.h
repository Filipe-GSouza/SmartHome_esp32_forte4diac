...
class FORTE_F_TIME_IN_NS_TO_UDINT final : public CSimpleFB {
  DECLARE_FIRMWARE_FB(FORTE_F_TIME_IN_NS_TO_UDINT)
...
public:
  FORTE_F_TIME_IN_NS_TO_UDINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes);

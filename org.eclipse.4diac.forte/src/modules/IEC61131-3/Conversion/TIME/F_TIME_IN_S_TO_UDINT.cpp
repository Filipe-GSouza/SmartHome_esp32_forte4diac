...
#include "F_TIME_IN_S_TO_UDINT.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "F_TIME_IN_S_TO_UDINT_gen.cpp"
#endif
...
DEFINE_FIRMWARE_FB(FORTE_F_TIME_IN_S_TO_UDINT, g_nStringIdF_TIME_IN_S_TO_UDINT)

const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataInputNames[] = {g_nStringIdIN};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataInputTypeIds[] = {g_nStringIdTIME};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataOutputNames[] = {g_nStringIdOUT};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataOutputTypeIds[] = {g_nStringIdUDINT};
const TDataIOID FORTE_F_TIME_IN_S_TO_UDINT::scmEIWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_TIME_IN_S_TO_UDINT::scmEIWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmEventInputNames[] = {g_nStringIdREQ};
const TDataIOID FORTE_F_TIME_IN_S_TO_UDINT::scmEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_TIME_IN_S_TO_UDINT::scmEOWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmEventOutputNames[] = {g_nStringIdCNF};
const SFBInterfaceSpec FORTE_F_TIME_IN_S_TO_UDINT::scmFBInterfaceSpec = {
...
FORTE_F_TIME_IN_S_TO_UDINT::FORTE_F_TIME_IN_S_TO_UDINT(const CStringDictionary::TStringId paInstanceNameId, CResource *const paSrcRes) :

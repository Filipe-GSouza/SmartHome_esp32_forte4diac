...
#include "DualHysteresis.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "signalprocessing/DualHysteresis_gen.cpp"
#endif
...
FORTE_signalprocessing__DualHysteresis::FORTE_signalprocessing__DualHysteresis(const CStringDictionary::TStringId paInstanceNameId, CResource *const paSrcRes) :
...
void FORTE_signalprocessing__DualHysteresis::enterStateSTART(CEventChainExecutionThread *const paECET) {
...
CIEC_ANY *FORTE_signalprocessing__DualHysteresis::getDIO(size_t) {
  return nullptr;
}
...
CInOutDataConnection **FORTE_signalprocessing__DualHysteresis::getDIOInConUnchecked(TPortId) {
  return nullptr;
}

CInOutDataConnection *FORTE_signalprocessing__DualHysteresis::getDIOOutConUnchecked(TPortId) {
  return nullptr;
}
